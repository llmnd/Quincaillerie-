...
def upgrade() -> None:
    ...
    if not sa.inspect(connection).has_table("farming_sites"):
        op.create_table(
            "farming_sites",
    ...
    create_index_if_missing("ix_farming_sites_id", "farming_sites", ["id"])
    create_index_if_missing("ix_farming_sites_organization_id", "farming_sites", ["organization_id"])

    if not sa.inspect(connection).has_table("farming_buildings"):
        op.create_table(
            "farming_buildings",
            sa.Column("id", sa.Integer(), primary_key=True),
            sa.Column("organization_id", sa.Integer(), sa.ForeignKey("organizations.id"), nullable=False),
    ...
    create_index_if_missing("ix_farming_buildings_id", "farming_buildings", ["id"])
    create_index_if_missing("ix_farming_buildings_organization_id", "farming_buildings", ["organization_id"])
    create_index_if_missing("ix_farming_buildings_site_id", "farming_buildings", ["site_id"])

    if not sa.inspect(connection).has_table("farming_batches"):
        op.create_table(
            "farming_batches",
            sa.Column("id", sa.Integer(), primary_key=True),
            sa.Column("organization_id", sa.Integer(), sa.ForeignKey("organizations.id"), nullable=False),
    ...
    create_index_if_missing("ix_farming_batches_id", "farming_batches", ["id"])
    create_index_if_missing("ix_farming_batches_organization_id", "farming_batches", ["organization_id"])
    create_index_if_missing("ix_farming_batches_building_id", "farming_batches", ["building_id"])
    create_index_if_missing("ix_farming_batches_reference", "farming_batches", ["reference"])

    if not sa.inspect(connection).has_table("farming_health_events"):
        op.create_table(
    ...
    create_index_if_missing("ix_farming_health_events_id", "farming_health_events", ["id"])
    create_index_if_missing("ix_farming_health_events_organization_id", "farming_health_events", ["organization_id"])
    create_index_if_missing("ix_farming_health_events_batch_id", "farming_health_events", ["batch_id"])
